...
public class myBookActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySnackBar = Snackbar.make(findViewById(R.id.layout_my_book), "Lista dei libri aggiornata", Snackbar.LENGTH_SHORT);

        Button btn_addToIhave = findViewById(R.id.btn_remove_from_mybooks);
        Button btn_addToWhishList = findViewById(R.id.btn_add_to_whislist_my_books);
        ...
        TextView txt_title = findViewById(R.id.txt_book_title_my_books);
        txt_title.setText(title);
        TextView txt_author = findViewById(R.id.txt_book_author_my_books);
        txt_author.setText("autore : " + author);
        TextView txt_year = findViewById(R.id.txt_publishing_year_my_books);
    ...
    public void onClick(View v) {
        new DatabaseOperationTask().execute(String.valueOf(v.getId()), bookDB);
    }
    ...
    class DatabaseOperationTask extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            if (viewId == R.id.btn_remove_from_mybooks) {
                removeBookFromList();
            } else if (viewId == R.id.btn_add_to_whislist_my_books) {
                addToWhishList();
            }
