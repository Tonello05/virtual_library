...
public class myBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        container = findViewById(R.id.container_my_books);
        ...
        new DatabaseOperationTaskMyBooks().execute(bookDB);
    ...
    class DatabaseOperationTaskMyBooks extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            myBooks = bookDB.getBookDAO().getWhislistBooks(false);
            bookDB.close();
        ...
        protected void onPostExecute(Void aVoid) {
            LinearLayout linearLayout = new LinearLayout(myBooksActivity.this);
            linearLayout.setOrientation(LinearLayout.VERTICAL);
            for (int i = 0; i < myBooks.size(); i++) {

                Button btn = new Button(myBooksActivity.this);
